...
import { Board, BoardCreationRequest, BoardListItem, ColumnCreationRequest, ColumnUpdateRequest, TaskCreationRequest, TaskUpdateRequest } from 'src/app/boards/services/board.service';
...
export const clearBoardError = createAction(
  ' [Board Page] Clear Board Error '
)
